/*
* Example code for Laskakit APDS9960 digital proximity, ambient light, RGB, and gesture sensor 
*
*
* Hardware:
* ESP32-C3-LPKit - https://www.laskakit.cz/laskkit-esp-12-board/
* SCD41 Senzor CO2, teploty a vlhkosti vzduchu  - https://www.laskakit.cz/laskakit-apds-9960-senzor-priblizeni-a-gest/
*
* Library:
